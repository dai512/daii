...
async function main_process() {
    if (process.argv.length !== 6) {
        ...
        if (process.argv[5] == 'bypass') {
            ...
            const proxyscrape_http = await axios.get('https://run.mocky.io/v3/3839e625-9817-4c21-aa55-28f62a67bc26');
            const proxy_list_http = await axios.get('https://run.mocky.io/v3/3839e625-9817-4c21-aa55-28f62a67bc26');
            const raw_github_http = await axios.get('https://run.mocky.io/v3/3839e625-9817-4c21-aa55-28f62a67bc26');
